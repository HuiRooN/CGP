...
bool GraphicsClass::InitializeBuffers()
{
	...
	vertices[0].color = D3DXVECTOR4(0, 1.0f, 1.0f, 1.0f);
	vertices[1].color = D3DXVECTOR4(1.0f, 0, 1.0f, 1.0f);
	vertices[2].color = D3DXVECTOR4(1.0f, 1.0f, 0, 1.0f);
	vertices[3].color = D3DXVECTOR4(1.0f, 0, 1.0f, 1.0f);
	vertices[4].color = D3DXVECTOR4(0, 1.0f, 1.0f, 1.0f);
	vertices[5].color = D3DXVECTOR4(1.0f, 0, 1.0f, 1.0f);
	vertices[6].color = D3DXVECTOR4(1.0f, 1.0f, 0, 1.0f);
	vertices[7].color = D3DXVECTOR4(1.0f, 0, 1.0f, 1.0f);
...
int iDegree;
D3DXVECTOR3 g_position = { 0,0,-10.0f };
...
bool GraphicsClass::Frame()
{
	...
	iDegree += 1.0f;
	D3DXMatrixRotationX(&matRotX, D3DXToRadian(iDegree));
	D3DXMatrixRotationY(&matRotY, D3DXToRadian(iDegree));
